...
impl EventLoop for MyTestApp {
    fn load(&mut self, gc2d: &mut Gc2d, _audio_manager: &mut gc2d::audio::AudioManager) -> Result<(), gc2d::event::EventError> {
    ...
    fn update(&mut self, gc2d: &mut Gc2d, _dt: f32, _audio_manager: &mut gc2d::audio::AudioManager) -> Result<(), gc2d::event::EventError> {
        self.x = gc2d.mouse.x;
        
        Ok(())
    }

    fn draw(&mut self, gc2d: &mut Gc2d, fonts: &mut gc2d::fonts::FontsManager, _dt: f32) -> Result<(), gc2d::event::EventError> {
